 ...
 * JPanel.
 */
public class JTiledLayeredPanel extends JLayeredPane {
  private static final long serialVersionUID = 23525252L;
   ...
   */
  public JTiledLayeredPanel(Color foreground, Color background) {
    super();
   ...
   */
  public JTiledLayeredPanel(Color foreground, Color background, boolean[][] texture) {
    super();
    ourDefaultForeground = (foreground != null ? foreground : Color.white);
    ourDefaultBackground = (background != null ? background : getBackground());
   ...
   * texture map and consisting of the given foreground and background colors.
   */
  public JTiledLayeredPanel(Color foreground, Color background, boolean[][] texture, int scale) {
    super();
    ourDefaultForeground = (foreground != null ? foreground : Color.white);
    ourDefaultBackground = (background != null ? background : getBackground());
   ...
   */
  public JTiledLayeredPanel(Image texture) {
    super();
    ourDefaultForeground = Color.white;
    ourDefaultBackground = getBackground();
   ...
   */
  public JTiledLayeredPanel(Icon textureIcon) {
    super();
    ourDefaultForeground = Color.white;
    ourDefaultBackground = getBackground();
